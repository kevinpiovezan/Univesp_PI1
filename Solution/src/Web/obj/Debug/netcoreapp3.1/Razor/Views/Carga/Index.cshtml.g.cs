#pragma checksum "/Users/kevinchristopherpiovezan/Documents/Univesp/Projeto_Integrador_1/Univesp_PI1/Solution/src/Web/Views/Carga/Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c5cea5b0c4e3f761aa64c389bc78a60fe463b74d"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c5cea5b0c4e3f761aa64c389bc78a60fe463b74d", @"/Views/Carga/Index.cshtml")]
...
#nullable disable
            WriteLiteral("\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "c5cea5b0c4e3f761aa64c389bc78a60fe463b74d4230", async() => {
            }
            );
 ...
 ");
    ...
    const mostraAlteracoesPopup = (criticas) => {
        ...
        for (let critica of criticas) {
            ...
            criticas_wrapper.");
            WriteLiteral(@"innerHTML += `<h6 class=""text-center mt-3"" style=""color:red;"">Se você seguir com a carga, os dados desses alunos serão atualizados com as informações presentes no excel anexado:</h6>`;
    ...
    function lerArquivoAsync(arquivo) {
        ...
        if (formatosValidos(arquivo)) {
          ...
          ");
            WriteLiteral(@"      cargaAlunos(dadosArquivo);
            };
