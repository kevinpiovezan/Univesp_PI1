#pragma checksum "C:\Users\s1110610\Meus Repositorios\PI\Solution\src\Web\Views\Carga\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0a6581e20403e3dc6526f6ed1f99612be2487e83"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Carga_Index), @"mvc.1.0.view", @"/Views/Carga/Index.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0a6581e20403e3dc6526f6ed1f99612be2487e83", @"/Views/Carga/Index.cshtml")]
    ...
    public class Views_Carga_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<Univesp.CaminhoDoMar.ProjetoIntegradorWeb.Models.AdminModel>
    {
        ...
        {
#nullable restore
#line 2 "C:\Users\s1110610\Meus Repositorios\PI\Solution\src\Web\Views\Carga\Index.cshtml"
...
#nullable disable
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "0a6581e20403e3dc6526f6ed1f99612be2487e834123", async() => {
            }
            );
...
<div class=""py-3"">
    ...
    <div id=""carga-alunos"">
                        ...
                        ");
            WriteLiteral(@"<div class=""my-2"" id=""info-ultima-alteracao-alunos""></div>
     ...
     ");
            WriteLiteral("   \r\n                            <span class=\"form-group col-lg-2 col-12\">\r\n                                <label");
            BeginWriteAttribute("for", " for=\"", 2330, "\"", 2336, 0);
            EndWriteAttribute();
            WriteLiteral(@" class=""mb-2"">Tipo de Carga:</label>
        
                                <span class=""form-check form-check-inline"">
                                    <input class=""form-check-input"" type=""radio"" name=""tipo_carga"" id=""inlineRadio1"" value=""completa"">
                                    <label class=""form-check-label"" for=""inlineRadio1"">Completa</label>
                                </span>
                                <span class=""form-check form-check-inline"">
                                    <input class=""form-check-input"" type=""radio"" name=""tipo_carga"" id=""inlineRadio2"" value=""incremental"">
                                    <label class=""form-check-label"" for=""inlineRadio2"">Incremental</label>
                                </span>
                            </span>
                        </p>
...
<script>
    ...
    const carregaAlunos = () => {
        ...
        $.ajax({
            ...
            for (let entry of data) {
                ...
                htmlLista += ""<t");
            WriteLiteral(@"d>"" + `${dataEmissao.getDate()}/${dataEmissao.getMonth()+1}/${dataEmissao.getFullYear()}` + ""</td>"";
    ...
    const baixarAlunos = () => {
        ...
        $.ajax({
            ...
            contentType: ""application/json"",
            data: JSON.stringify(parseInt($(""#sel_ciclo_alunos");
            WriteLiteral(@""").val()))
        }).done(function (data) {
            toggleLoading()
            if (!data) {
    ...
    const cargaAlunos = (dados) => {
        ...
        $.ajax({
            ...
            // toastr.error(xhr.responseText);
            toastr.error(""Usuário não tem as permissões necessárias para realizar a carga"");
        });
    }

    const cargaAlunosConfirmar = () => {
");
            WriteLiteral(@"        dadosCarga.confirmado = true;
