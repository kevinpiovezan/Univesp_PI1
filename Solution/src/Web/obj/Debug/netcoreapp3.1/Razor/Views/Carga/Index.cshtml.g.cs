#pragma checksum "/Users/kevinchristopherpiovezan/Documents/Univesp/Projeto_Integrador_1/Univesp_PI1/Solution/src/Web/Views/Carga/Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "01dd3727720c3453db764a605c9209bd06c8a5fe"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"01dd3727720c3453db764a605c9209bd06c8a5fe", @"/Views/Carga/Index.cshtml")]
...
#nullable disable
            WriteLiteral("\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "01dd3727720c3453db764a605c9209bd06c8a5fe4230", async() => {
            }
            );
        ...
        $.ajax({
          ...
          ");
            ...
            WriteLiteral(@"          status = ""CONCLUIDA"";
                ...
                htmlLista += ""<td>"" + entry.e");
            WriteLiteral(@"ndereco + ""</td>"";
 ...
 ");
    ...
    const mostraCriticasPopup = (criticas) => {
        ...
        for (let critica of criticas) {
            ...
            if (critica.linha != 0)
                ...
                critic");
            WriteLiteral(@"as_wrapper.innerHTML += `<h6 class=""text-center font-weight-bold mt-3"" style=""color:red;"">Erro:</h6>`;
    ...
    const mostraAlteracoesPopup = (criticas) => {
        ...
        for (let critica of criticas) {
            ...
            criticas_wrapper.innerHTML += `<h6 class=");
            WriteLiteral(@"""text-center mt-3"" style=""color:red;"">Se você seguir com a carga, os dados desses alunos serão atualizados com as informações presentes no excel anexado:</h6>`;
